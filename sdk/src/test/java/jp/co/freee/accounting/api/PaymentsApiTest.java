...
public class PaymentsApiTest {
    ...
    public void createDealPaymentTest() {
        Integer id = null;
        DealPaymentParams parameters = null;
        // DealsResponse response = api.createDealPayment(id, parameters);
    ...
    public void updateDealPaymentTest() {
        ...
        Integer paymentId = null;
        DealPaymentParams parameters = null;
        // DealsResponse response = api.updateDealPayment(id, paymentId, parameters);
