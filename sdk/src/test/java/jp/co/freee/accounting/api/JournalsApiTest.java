...
public class JournalsApiTest {
    ...
    public void downloadJournalTest() {
        ...
        // api.downloadJournal(id, companyId);
    ...
    public void getJournalStatusTest() {
        ...
        String endDate = null;
        // JournalsStatusResponse response = api.getJournalStatus(id, companyId, visibleTags, startDate, endDate);
    ...
    public void getJournalsTest() {
        ...
        String startDate = null;
        String endDate = null;
        // JournalsEnqueueJournalsResponse response = api.getJournals(downloadType, companyId, visibleTags, startDate, endDate);
