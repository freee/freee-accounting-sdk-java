...
public class RenewsApiTest {
    ...
    public void createDealRenewTest() {
        Integer id = null;
        RenewsCreateParams parameters = null;
        // RenewsResponse response = api.createDealRenew(id, parameters);
    ...
    public void deleteDealRenewTest() {
        ...
        // RenewsResponse response = api.deleteDealRenew(id, renewId, companyId);
    ...
    public void updateDealRenewTest() {
        Integer id = null;
        Integer renewId = null;
        RenewsUpdateParams parameters = null;
        // RenewsResponse response = api.updateDealRenew(id, renewId, parameters);
