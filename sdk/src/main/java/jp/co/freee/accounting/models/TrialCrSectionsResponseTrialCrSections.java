...
import jp.co.freee.accounting.models.TrialCrSectionsResponseTrialCrSectionsBalances;

/**
 * TrialCrSectionsResponseTrialCrSections
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class TrialCrSectionsResponseTrialCrSections {
  /**
  ...
  private List<TrialCrSectionsResponseTrialCrSectionsBalances> balances = new ArrayList<>();
  ...
  public TrialCrSectionsResponseTrialCrSections() { 
  }

  public TrialCrSectionsResponseTrialCrSections accountItemDisplayType(AccountItemDisplayTypeEnum accountItemDisplayType) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections adjustment(AdjustmentEnum adjustment) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections approvalFlowStatus(ApprovalFlowStatusEnum approvalFlowStatus) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections balances(List<TrialCrSectionsResponseTrialCrSectionsBalances> balances) {
    
    this.balances = balances;
    return this;
  }

  public TrialCrSectionsResponseTrialCrSections addBalancesItem(TrialCrSectionsResponseTrialCrSectionsBalances balancesItem) {
  ...
  **/
  ...
  public List<TrialCrSectionsResponseTrialCrSectionsBalances> getBalances() {
    return balances;
  }


  public void setBalances(List<TrialCrSectionsResponseTrialCrSectionsBalances> balances) {
    this.balances = balances;
  }


  public TrialCrSectionsResponseTrialCrSections breakdownDisplayType(BreakdownDisplayTypeEnum breakdownDisplayType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "内訳の表示（取引先: partner, 品目: item, 勘定科目: account_item, セグメント1(法人向けプロフェッショナル, 法人向けエンタープライズプラン): segment_1_tag, セグメント2(法人向け エンタープライズプラン):segment_2_tag, セグメント3(法人向け エンタープライズプラン): segment_3_tag）(条件に指定した時のみ含まれる）")
  ...
  public TrialCrSectionsResponseTrialCrSections companyId(Integer companyId) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections costAllocation(CostAllocationEnum costAllocation) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections createdAt(String createdAt) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections endDate(String endDate) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections endMonth(Integer endMonth) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections fiscalYear(Integer fiscalYear) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections itemId(Integer itemId) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections partnerCode(String partnerCode) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections partnerId(Integer partnerId) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections sectionIds(String sectionIds) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections startDate(String startDate) {
  ...
  **/
  ...
  public TrialCrSectionsResponseTrialCrSections startMonth(Integer startMonth) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrialCrSectionsResponseTrialCrSections trialCrSectionsResponseTrialCrSections = (TrialCrSectionsResponseTrialCrSections) o;
    return Objects.equals(this.accountItemDisplayType, trialCrSectionsResponseTrialCrSections.accountItemDisplayType) &&
        Objects.equals(this.adjustment, trialCrSectionsResponseTrialCrSections.adjustment) &&
        Objects.equals(this.approvalFlowStatus, trialCrSectionsResponseTrialCrSections.approvalFlowStatus) &&
        Objects.equals(this.balances, trialCrSectionsResponseTrialCrSections.balances) &&
        Objects.equals(this.breakdownDisplayType, trialCrSectionsResponseTrialCrSections.breakdownDisplayType) &&
        Objects.equals(this.companyId, trialCrSectionsResponseTrialCrSections.companyId) &&
        Objects.equals(this.costAllocation, trialCrSectionsResponseTrialCrSections.costAllocation) &&
        Objects.equals(this.createdAt, trialCrSectionsResponseTrialCrSections.createdAt) &&
        Objects.equals(this.endDate, trialCrSectionsResponseTrialCrSections.endDate) &&
        Objects.equals(this.endMonth, trialCrSectionsResponseTrialCrSections.endMonth) &&
        Objects.equals(this.fiscalYear, trialCrSectionsResponseTrialCrSections.fiscalYear) &&
        Objects.equals(this.itemId, trialCrSectionsResponseTrialCrSections.itemId) &&
        Objects.equals(this.partnerCode, trialCrSectionsResponseTrialCrSections.partnerCode) &&
        Objects.equals(this.partnerId, trialCrSectionsResponseTrialCrSections.partnerId) &&
        Objects.equals(this.sectionIds, trialCrSectionsResponseTrialCrSections.sectionIds) &&
        Objects.equals(this.startDate, trialCrSectionsResponseTrialCrSections.startDate) &&
        Objects.equals(this.startMonth, trialCrSectionsResponseTrialCrSections.startMonth);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountItemDisplayType, adjustment, approvalFlowStatus, balances, breakdownDisplayType, companyId, costAllocation, createdAt, endDate, endMonth, fiscalYear, itemId, partnerCode, partnerId, sectionIds, startDate, startMonth);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrialCrSectionsResponseTrialCrSections {\n");
