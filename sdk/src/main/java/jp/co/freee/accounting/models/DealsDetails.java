...
public class DealsDetails {
  ...
  public DealsDetails id(Integer id) {
  ...
  **/
  ...
  public DealsDetails accountItemId(Integer accountItemId) {
  ...
  **/
  @ApiModelProperty(example = "803", required = true, value = "勘定科目ID")
  ...
  public DealsDetails taxId(Integer taxId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "14", value = "税区分ID（廃止予定）")
  ...
  public DealsDetails taxCode(Integer taxCode) {
   ...
   * @return taxCode
  **/
  @ApiModelProperty(example = "2", required = true, value = "税区分コード")
  ...
  public DealsDetails itemId(Integer itemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "501", value = "品目ID")
  ...
  public DealsDetails sectionId(Integer sectionId) {
  ...
  **/
  ...
  public DealsDetails tagIds(List<Integer> tagIds) {
    
    this.tagIds = tagIds;
    return this;
  }

  public DealsDetails addTagIdsItem(Integer tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  ...
  public DealsDetails segment1TagId(Integer segment1TagId) {
  ...
  **/
  ...
  public DealsDetails segment2TagId(Integer segment2TagId) {
  ...
  **/
  ...
  public DealsDetails segment3TagId(Integer segment3TagId) {
  ...
  **/
  ...
  public DealsDetails amount(Integer amount) {
  ...
  **/
  ...
  public DealsDetails vat(Integer vat) {
   ...
   * @return vat
  **/
  @ApiModelProperty(example = "250", required = true, value = "消費税額")
  ...
  public DealsDetails description(String description) {
  ...
  **/
  ...
  public DealsDetails entrySide(EntrySideEnum entrySide) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DealsDetails dealsDetails = (DealsDetails) o;
    return Objects.equals(this.id, dealsDetails.id) &&
        Objects.equals(this.accountItemId, dealsDetails.accountItemId) &&
        Objects.equals(this.taxId, dealsDetails.taxId) &&
        Objects.equals(this.taxCode, dealsDetails.taxCode) &&
        Objects.equals(this.itemId, dealsDetails.itemId) &&
        Objects.equals(this.sectionId, dealsDetails.sectionId) &&
        Objects.equals(this.tagIds, dealsDetails.tagIds) &&
        Objects.equals(this.segment1TagId, dealsDetails.segment1TagId) &&
        Objects.equals(this.segment2TagId, dealsDetails.segment2TagId) &&
        Objects.equals(this.segment3TagId, dealsDetails.segment3TagId) &&
        Objects.equals(this.amount, dealsDetails.amount) &&
        Objects.equals(this.vat, dealsDetails.vat) &&
        Objects.equals(this.description, dealsDetails.description) &&
        Objects.equals(this.entrySide, dealsDetails.entrySide);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accountItemId, taxId, taxCode, itemId, sectionId, tagIds, segment1TagId, segment2TagId, segment3TagId, amount, vat, description, entrySide);
  }
