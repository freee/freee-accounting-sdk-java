...
public class ManualJournal {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, issueDate, adjustment, txnNumber, details);
  }
