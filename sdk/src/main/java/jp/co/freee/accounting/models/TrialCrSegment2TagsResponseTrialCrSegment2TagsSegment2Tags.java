...
public class TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags {
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags closingBalance(Integer closingBalance) {
  ...
  **/
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags id(Integer id) {
  ...
  **/
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags items(List<TrialCrSectionsResponseTrialCrSectionsItems> items) {
    
    this.items = items;
    return this;
  }

  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags addItemsItem(TrialCrSectionsResponseTrialCrSectionsItems itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags name(String name) {
  ...
  **/
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags partners(List<TrialCrSectionsResponseTrialCrSectionsPartners> partners) {
    
    this.partners = partners;
    return this;
  }

  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags addPartnersItem(TrialCrSectionsResponseTrialCrSectionsPartners partnersItem) {
  ...
  **/
  ...
  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags sections(List<TrialCrSegment1TagsResponseTrialCrSegment1TagsSections> sections) {
    
    this.sections = sections;
    return this;
  }

  public TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags addSectionsItem(TrialCrSegment1TagsResponseTrialCrSegment1TagsSections sectionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags = (TrialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags) o;
    return Objects.equals(this.closingBalance, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.closingBalance) &&
        Objects.equals(this.id, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.id) &&
        Objects.equals(this.items, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.items) &&
        Objects.equals(this.name, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.name) &&
        Objects.equals(this.partners, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.partners) &&
        Objects.equals(this.sections, trialCrSegment2TagsResponseTrialCrSegment2TagsSegment2Tags.sections);
  }
