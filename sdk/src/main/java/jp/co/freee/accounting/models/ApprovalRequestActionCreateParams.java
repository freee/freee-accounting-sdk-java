...
public class ApprovalRequestActionCreateParams {
  ...
  public ApprovalRequestActionCreateParams() { 
  }

  public ApprovalRequestActionCreateParams approvalAction(ApprovalActionEnum approvalAction) {
  ...
  **/
  ...
  public ApprovalRequestActionCreateParams companyId(Integer companyId) {
  ...
  **/
  ...
  public ApprovalRequestActionCreateParams nextApproverId(Integer nextApproverId) {
  ...
  **/
  ...
  public ApprovalRequestActionCreateParams targetRound(Integer targetRound) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。各種申請の取得APIレスポンス.current_roundを送信してください。")
  ...
  public ApprovalRequestActionCreateParams targetStepId(Integer targetStepId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "対象承認ステップID 各種申請の取得APIレスポンス.current_step_idを送信してください。")
  ...
  public boolean equals(Object o) {
    ...
    ApprovalRequestActionCreateParams approvalRequestActionCreateParams = (ApprovalRequestActionCreateParams) o;
    return Objects.equals(this.approvalAction, approvalRequestActionCreateParams.approvalAction) &&
        Objects.equals(this.companyId, approvalRequestActionCreateParams.companyId) &&
        Objects.equals(this.nextApproverId, approvalRequestActionCreateParams.nextApproverId) &&
        Objects.equals(this.targetRound, approvalRequestActionCreateParams.targetRound) &&
        Objects.equals(this.targetStepId, approvalRequestActionCreateParams.targetStepId);
  }
