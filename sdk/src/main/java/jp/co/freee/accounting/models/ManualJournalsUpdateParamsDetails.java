...
public class ManualJournalsUpdateParamsDetails {
  ...
  public ManualJournalsUpdateParamsDetails id(Integer id) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails entrySide(EntrySideEnum entrySide) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails taxCode(Integer taxCode) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails accountItemId(Integer accountItemId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails amount(Integer amount) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails vat(Integer vat) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails partnerId(Integer partnerId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails partnerCode(String partnerCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "code111", value = "取引先コード")
  ...
  public ManualJournalsUpdateParamsDetails itemId(Integer itemId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails sectionId(Integer sectionId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails tagIds(List<Integer> tagIds) {
    
    this.tagIds = tagIds;
    return this;
  }

  public ManualJournalsUpdateParamsDetails addTagIdsItem(Integer tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails segment1TagId(Integer segment1TagId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails segment2TagId(Integer segment2TagId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails segment3TagId(Integer segment3TagId) {
  ...
  **/
  ...
  public ManualJournalsUpdateParamsDetails description(String description) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ManualJournalsUpdateParamsDetails manualJournalsUpdateParamsDetails = (ManualJournalsUpdateParamsDetails) o;
    return Objects.equals(this.id, manualJournalsUpdateParamsDetails.id) &&
        Objects.equals(this.entrySide, manualJournalsUpdateParamsDetails.entrySide) &&
        Objects.equals(this.taxCode, manualJournalsUpdateParamsDetails.taxCode) &&
        Objects.equals(this.accountItemId, manualJournalsUpdateParamsDetails.accountItemId) &&
        Objects.equals(this.amount, manualJournalsUpdateParamsDetails.amount) &&
        Objects.equals(this.vat, manualJournalsUpdateParamsDetails.vat) &&
        Objects.equals(this.partnerId, manualJournalsUpdateParamsDetails.partnerId) &&
        Objects.equals(this.partnerCode, manualJournalsUpdateParamsDetails.partnerCode) &&
        Objects.equals(this.itemId, manualJournalsUpdateParamsDetails.itemId) &&
        Objects.equals(this.sectionId, manualJournalsUpdateParamsDetails.sectionId) &&
        Objects.equals(this.tagIds, manualJournalsUpdateParamsDetails.tagIds) &&
        Objects.equals(this.segment1TagId, manualJournalsUpdateParamsDetails.segment1TagId) &&
        Objects.equals(this.segment2TagId, manualJournalsUpdateParamsDetails.segment2TagId) &&
        Objects.equals(this.segment3TagId, manualJournalsUpdateParamsDetails.segment3TagId) &&
        Objects.equals(this.description, manualJournalsUpdateParamsDetails.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, entrySide, taxCode, accountItemId, amount, vat, partnerId, partnerCode, itemId, sectionId, tagIds, segment1TagId, segment2TagId, segment3TagId, description);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManualJournalsUpdateParamsDetails {\n");
