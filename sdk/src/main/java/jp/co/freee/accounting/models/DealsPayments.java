...
public class DealsPayments {
  ...
  public DealsPayments id(Integer id) {
  ...
  **/
  ...
  public DealsPayments date(String date) {
   ...
   * @return date
  **/
  @ApiModelProperty(example = "2013-01-28", required = true, value = "支払日")
  ...
  public DealsPayments fromWalletableType(FromWalletableTypeEnum fromWalletableType) {
  ...
  **/
  ...
  @ApiModelProperty(example = "bank_account", value = "口座区分 (銀行口座: bank_account, クレジットカード: credit_card, 現金: wallet, プライベート資金（法人の場合は役員借入金もしくは役員借入金、個人の場合は事業主貸もしくは事業主借）: private_account_item)")
  ...
  public DealsPayments fromWalletableId(Integer fromWalletableId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "103", value = "口座ID（from_walletable_typeがprivate_account_itemの場合は勘定科目ID）")
  ...
  public DealsPayments amount(Integer amount) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DealsPayments dealsPayments = (DealsPayments) o;
    return Objects.equals(this.id, dealsPayments.id) &&
        Objects.equals(this.date, dealsPayments.date) &&
        Objects.equals(this.fromWalletableType, dealsPayments.fromWalletableType) &&
        Objects.equals(this.fromWalletableId, dealsPayments.fromWalletableId) &&
        Objects.equals(this.amount, dealsPayments.amount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, date, fromWalletableType, fromWalletableId, amount);
  }
