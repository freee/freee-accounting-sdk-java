...
import jp.co.freee.accounting.models.ReceiptUser;
...
public class Receipt {
  ...
  **/
  ...
  public Receipt user(ReceiptUser user) {
  ...
  **/
  ...
  public ReceiptUser getUser() {
    return user;
  }


  public void setUser(ReceiptUser user) {
    this.user = user;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, status, description, mimeType, issueDate, origin, createdAt, fileSrc, user);
  }
