...
public class AccountItemParamsAccountItem {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "勘定科目名 (30文字以内)")
  ...
  **/
  ...
  @ApiModelProperty(value = "ショートカット1 (20文字以内)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ショートカット2(勘定科目コード)(20文字以内)")
  ...
  public AccountItemParamsAccountItem taxName(String taxName) {
   ...
   * @return taxName
  **/
  @ApiModelProperty(required = true, value = "税区分")
   ...
   * @return groupName
  **/
  @ApiModelProperty(required = true, value = "決算書表示名")
  ...
  public AccountItemParamsAccountItem accountCategory(String accountCategory) {
  ...
  **/
  @ApiModelProperty(required = true, value = "勘定科目カテゴリー")
  ...
  public AccountItemParamsAccountItem correspondingIncomeName(String correspondingIncomeName) {
  ...
  **/
  @ApiModelProperty(required = true, value = "収入取引相手勘定科目")
  ...
  public AccountItemParamsAccountItem correspondingExpenseName(String correspondingExpenseName) {
  ...
  **/
  @ApiModelProperty(required = true, value = "支出取引相手勘定科目")
  ...
  public AccountItemParamsAccountItem accumulatedDepAccountItemName(String accumulatedDepAccountItemName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "減価償却累計額勘定科目")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "検索可能:2, 検索不可：3")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, accountItemParamsAccountItem.name) &&
        ...
        Objects.equals(this.taxName, accountItemParamsAccountItem.taxName) &&
        Objects.equals(this.groupName, accountItemParamsAccountItem.groupName) &&
        Objects.equals(this.accountCategory, accountItemParamsAccountItem.accountCategory) &&
        Objects.equals(this.correspondingIncomeName, accountItemParamsAccountItem.correspondingIncomeName) &&
        Objects.equals(this.correspondingExpenseName, accountItemParamsAccountItem.correspondingExpenseName) &&
        Objects.equals(this.accumulatedDepAccountItemName, accountItemParamsAccountItem.accumulatedDepAccountItemName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, shortcut, shortcutNum, taxName, groupName, accountCategory, correspondingIncomeName, correspondingExpenseName, accumulatedDepAccountItemName, searchable, items, partners);
  }
