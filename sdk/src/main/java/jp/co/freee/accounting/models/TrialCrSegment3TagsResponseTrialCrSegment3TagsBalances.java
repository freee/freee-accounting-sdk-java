...
import jp.co.freee.accounting.models.TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags;

/**
 * TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances {
  ...
  private List<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags> segment3Tags = null;
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances() { 
  }

  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances accountCategoryName(String accountCategoryName) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances accountGroupName(String accountGroupName) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances accountItemId(Integer accountItemId) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances accountItemName(String accountItemName) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances closingBalance(Integer closingBalance) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances hierarchyLevel(Integer hierarchyLevel) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances parentAccountCategoryName(String parentAccountCategoryName) {
  ...
  **/
  ...
  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances segment3Tags(List<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags> segment3Tags) {
    
    this.segment3Tags = segment3Tags;
    return this;
  }

  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances addSegment3TagsItem(TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags segment3TagsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "セグメント3タグ")

  public List<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags> getSegment3Tags() {
    return segment3Tags;
  }


  public void setSegment3Tags(List<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags> segment3Tags) {
    this.segment3Tags = segment3Tags;
  }


  public TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances totalLine(Boolean totalLine) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances trialCrSegment3TagsResponseTrialCrSegment3TagsBalances = (TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances) o;
    return Objects.equals(this.accountCategoryName, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.accountCategoryName) &&
        Objects.equals(this.accountGroupName, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.accountGroupName) &&
        Objects.equals(this.accountItemId, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.accountItemId) &&
        Objects.equals(this.accountItemName, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.accountItemName) &&
        Objects.equals(this.closingBalance, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.closingBalance) &&
        Objects.equals(this.hierarchyLevel, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.hierarchyLevel) &&
        Objects.equals(this.parentAccountCategoryName, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.parentAccountCategoryName) &&
        Objects.equals(this.segment3Tags, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.segment3Tags) &&
        Objects.equals(this.totalLine, trialCrSegment3TagsResponseTrialCrSegment3TagsBalances.totalLine);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountCategoryName, accountGroupName, accountItemId, accountItemName, closingBalance, hierarchyLevel, parentAccountCategoryName, segment3Tags, totalLine);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances {\n");
