...
public class TagsParams {
  ...
  public TagsParams companyId(Integer companyId) {
  ...
  **/
  ...
  public TagsParams name(String name) {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "メモタグ1", required = true, value = "メモタグ名 (30文字以内)")
  ...
  public TagsParams shortcut1(String shortcut1) {
  ...
  **/
  ...
  @ApiModelProperty(example = "tag1", value = "メモタグ検索用 (20文字以内)")
  ...
  public TagsParams shortcut2(String shortcut2) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "t1", value = "メモタグ検索用 (20文字以内)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TagsParams tagsParams = (TagsParams) o;
    return Objects.equals(this.companyId, tagsParams.companyId) &&
        Objects.equals(this.name, tagsParams.name) &&
        Objects.equals(this.shortcut1, tagsParams.shortcut1) &&
        Objects.equals(this.shortcut2, tagsParams.shortcut2);
  }
