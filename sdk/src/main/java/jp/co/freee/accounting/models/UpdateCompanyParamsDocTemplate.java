...
public class UpdateCompanyParamsDocTemplate {
  ...
  public UpdateCompanyParamsDocTemplate invoiceLayout(Integer invoiceLayout) {
  ...
  **/
  ...
  @ApiModelProperty(value = "レイアウト(0: レイアウト1, 1:レイアウト2, 3:封筒1, 4:レイアウト3(繰越金額欄あり), 5: 封筒2(繰越金額欄あり))")
  ...
  public UpdateCompanyParamsDocTemplate invoiceStyle(Integer invoiceStyle) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "スタイル(0: クラシック, 1: モダン)")
  ...
  public UpdateCompanyParamsDocTemplate amountFraction(Integer amountFraction) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "金額端数処理方法（0: 切り上げ、1: 切り捨て, 2: 四捨五入）")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateCompanyParamsDocTemplate updateCompanyParamsDocTemplate = (UpdateCompanyParamsDocTemplate) o;
    return Objects.equals(this.invoiceLayout, updateCompanyParamsDocTemplate.invoiceLayout) &&
        Objects.equals(this.invoiceStyle, updateCompanyParamsDocTemplate.invoiceStyle) &&
        Objects.equals(this.amountFraction, updateCompanyParamsDocTemplate.amountFraction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceLayout, invoiceStyle, amountFraction);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCompanyParamsDocTemplate {\n");
