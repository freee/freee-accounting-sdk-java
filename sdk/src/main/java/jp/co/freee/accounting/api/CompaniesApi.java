...
public interface CompaniesApi {
   ...
   * @return Observable&lt;CompaniesIndexResponse&gt;
   */
  @GET("api/1/companies")
  Observable<CompaniesIndexResponse> getCompanies();
   ...
   * @return Observable&lt;CompaniesShowResponse&gt;
   */
  @GET("api/1/companies/{id}")
  Observable<CompaniesShowResponse> getCompany(
   ...
   * @return Observable&lt;CompaniesUpdateResponse&gt;
   */
  @Headers({
    "Content-Type:application/json"
  })
  @PUT("api/1/companies/{id}")
  Observable<CompaniesUpdateResponse> updateCompany(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body UpdateCompanyParams parameters
  );
