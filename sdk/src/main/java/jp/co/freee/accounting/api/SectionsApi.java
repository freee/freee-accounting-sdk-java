...
public interface SectionsApi {
   ...
   * @param parameters 部門の作成 (optional)
   * @return Observable&lt;SectionsCreateResponse&gt;
   */
  @Headers({
    "Content-Type:application/json"
  })
  @POST("api/1/sections")
  Observable<SectionsCreateResponse> createSection(
    @retrofit2.http.Body SectionParams parameters
  );
   ...
   * @param companyId 事業所ID (required)
   * @return Observable&lt;SectionsShowResponse&gt;
   */
  @GET("api/1/sections/{id}")
  Observable<SectionsShowResponse> getSection(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Query("company_id") Integer companyId
  );
   ...
   * @param companyId 事業所ID (required)
   * @return Observable&lt;SectionsIndexResponse&gt;
   */
  @GET("api/1/sections")
  Observable<SectionsIndexResponse> getSections(
   ...
   * @param id  (required)
   * @param parameters 部門の更新 (optional)
   * @return Observable&lt;SectionsUpdateResponse&gt;
   */
  @Headers({
    "Content-Type:application/json"
  })
  @PUT("api/1/sections/{id}")
  Observable<SectionsUpdateResponse> updateSection(
    @retrofit2.http.Path("id") Integer id, @retrofit2.http.Body SectionParams parameters
  );
