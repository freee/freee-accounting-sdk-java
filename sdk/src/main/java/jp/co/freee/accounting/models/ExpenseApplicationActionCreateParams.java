...
public class ExpenseApplicationActionCreateParams {
  /**
  ...
  public ExpenseApplicationActionCreateParams() { 
  }

  public ExpenseApplicationActionCreateParams approvalAction(ApprovalActionEnum approvalAction) {
  ...
  **/
  ...
  public ExpenseApplicationActionCreateParams companyId(Integer companyId) {
  ...
  **/
  ...
  public ExpenseApplicationActionCreateParams nextApproverId(Integer nextApproverId) {
  ...
  **/
  ...
  public ExpenseApplicationActionCreateParams targetRound(Integer targetRound) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。経費申請の取得APIレスポンス.current_roundを送信してください。")
  ...
  public ExpenseApplicationActionCreateParams targetStepId(Integer targetStepId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "対象承認ステップID 経費申請の取得APIレスポンス.current_step_idを送信してください。")
  ...
  public boolean equals(Object o) {
    ...
    ExpenseApplicationActionCreateParams expenseApplicationActionCreateParams = (ExpenseApplicationActionCreateParams) o;
    return Objects.equals(this.approvalAction, expenseApplicationActionCreateParams.approvalAction) &&
        Objects.equals(this.companyId, expenseApplicationActionCreateParams.companyId) &&
        Objects.equals(this.nextApproverId, expenseApplicationActionCreateParams.nextApproverId) &&
        Objects.equals(this.targetRound, expenseApplicationActionCreateParams.targetRound) &&
        Objects.equals(this.targetStepId, expenseApplicationActionCreateParams.targetStepId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpenseApplicationActionCreateParams {\n");
