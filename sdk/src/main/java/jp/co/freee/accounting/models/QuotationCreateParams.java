...
public class QuotationCreateParams {
  ...
  private List<InvoiceCreateParamsInvoiceContents> quotationContents = null;
  ...
  **/
  ...
  public QuotationCreateParams quotationContents(List<InvoiceCreateParamsInvoiceContents> quotationContents) {
  ...
  **/
  ...
  public List<InvoiceCreateParamsInvoiceContents> getQuotationContents() {
    return quotationContents;
  }


  public void setQuotationContents(List<InvoiceCreateParamsInvoiceContents> quotationContents) {
    this.quotationContents = quotationContents;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "default_classic", value = "請求書レイアウト * `default_classic` - レイアウト１/クラシック (デフォルト)  * `standard_classic` - レイアウト２/クラシック  * `envelope_classic` - 封筒１/クラシック  * `default_modern` - レイアウト１/モダン  * `standard_modern` - レイアウト２/モダン  * `envelope_modern` - 封筒/モダン")
