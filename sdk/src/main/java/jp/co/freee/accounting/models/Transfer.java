...
public class Transfer {
  ...
  **/
   ...
   * @return date
  **/
  @ApiModelProperty(example = "2019-11-01", required = true, value = "振替日 (yyyy-mm-dd)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, companyId, amount, date, fromWalletableType, fromWalletableId, toWalletableType, toWalletableId, description);
  }
