...
public class TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags {
  ...
  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags() { 
  }

  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags closingBalance(Integer closingBalance) {
  ...
  **/
  ...
  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags id(Integer id) {
  ...
  **/
  ...
  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags lastYearClosingBalance(Integer lastYearClosingBalance) {
  ...
  **/
  ...
  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags name(String name) {
  ...
  **/
  ...
  public TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags yearOnYear(BigDecimal yearOnYear) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags = (TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags) o;
    return Objects.equals(this.closingBalance, trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags.closingBalance) &&
        Objects.equals(this.id, trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags.id) &&
        Objects.equals(this.lastYearClosingBalance, trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags.lastYearClosingBalance) &&
        Objects.equals(this.name, trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags.name) &&
        Objects.equals(this.yearOnYear, trialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags.yearOnYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags {\n");
