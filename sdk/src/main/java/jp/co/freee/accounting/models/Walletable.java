...
public class Walletable {
  ...
  public static final String SERIALIZED_NAME_LAST_BALANCE = "last_balance";
  @SerializedName(SERIALIZED_NAME_LAST_BALANCE)
  private Integer lastBalance;

  public static final String SERIALIZED_NAME_WALLETABLE_BALANCE = "walletable_balance";
  @SerializedName(SERIALIZED_NAME_WALLETABLE_BALANCE)
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "freee銀行", required = true, value = "口座名 (255文字以内)")
  ...
  **/
  ...
  @ApiModelProperty(example = "3", required = true, value = "サービスID")
  ...
  public Walletable type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1565583", value = "同期残高")
  ...
  public Walletable walletableBalance(Integer walletableBalance) {
   ...
   /**
   * 登録残高
   * @return walletableBalance
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1340261", value = "登録残高")

  public Integer getWalletableBalance() {
    return walletableBalance;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Walletable walletable = (Walletable) o;
    return Objects.equals(this.id, walletable.id) &&
        Objects.equals(this.name, walletable.name) &&
        Objects.equals(this.bankId, walletable.bankId) &&
        Objects.equals(this.type, walletable.type) &&
        Objects.equals(this.lastBalance, walletable.lastBalance) &&
        Objects.equals(this.walletableBalance, walletable.walletableBalance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, bankId, type, lastBalance, walletableBalance);
  }
  ...
  public String toString() {
    ...
    sb.append("    walletableBalance: ").append(toIndentedString(walletableBalance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
