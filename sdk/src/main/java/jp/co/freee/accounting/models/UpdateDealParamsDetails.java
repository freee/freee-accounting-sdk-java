...
public class UpdateDealParamsDetails {
  ...
  public UpdateDealParamsDetails id(Integer id) {
  ...
  **/
  ...
  public UpdateDealParamsDetails taxCode(Integer taxCode) {
  ...
  **/
  ...
  public UpdateDealParamsDetails taxId(Integer taxId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "税区分ID（廃止予定。上記tax_codeを使用してください。tax_code, tax_idはどちらかの指定が必須です。）")
  ...
  public UpdateDealParamsDetails accountItemId(Integer accountItemId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails amount(Integer amount) {
  ...
  **/
  ...
  public UpdateDealParamsDetails itemId(Integer itemId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails sectionId(Integer sectionId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails tagIds(List<Integer> tagIds) {
    
    this.tagIds = tagIds;
    return this;
  }

  public UpdateDealParamsDetails addTagIdsItem(Integer tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  ...
  public UpdateDealParamsDetails segment1TagId(Integer segment1TagId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails segment2TagId(Integer segment2TagId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails segment3TagId(Integer segment3TagId) {
  ...
  **/
  ...
  public UpdateDealParamsDetails description(String description) {
  ...
  **/
  ...
  public UpdateDealParamsDetails vat(Integer vat) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateDealParamsDetails updateDealParamsDetails = (UpdateDealParamsDetails) o;
    return Objects.equals(this.id, updateDealParamsDetails.id) &&
        Objects.equals(this.taxCode, updateDealParamsDetails.taxCode) &&
        Objects.equals(this.taxId, updateDealParamsDetails.taxId) &&
        Objects.equals(this.accountItemId, updateDealParamsDetails.accountItemId) &&
        Objects.equals(this.amount, updateDealParamsDetails.amount) &&
        Objects.equals(this.itemId, updateDealParamsDetails.itemId) &&
        Objects.equals(this.sectionId, updateDealParamsDetails.sectionId) &&
        Objects.equals(this.tagIds, updateDealParamsDetails.tagIds) &&
        Objects.equals(this.segment1TagId, updateDealParamsDetails.segment1TagId) &&
        Objects.equals(this.segment2TagId, updateDealParamsDetails.segment2TagId) &&
        Objects.equals(this.segment3TagId, updateDealParamsDetails.segment3TagId) &&
        Objects.equals(this.description, updateDealParamsDetails.description) &&
        Objects.equals(this.vat, updateDealParamsDetails.vat);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, taxCode, taxId, accountItemId, amount, itemId, sectionId, tagIds, segment1TagId, segment2TagId, segment3TagId, description, vat);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDealParamsDetails {\n");
