...
public class RenewUpdateParamsDetails {
  ...
  public RenewUpdateParamsDetails() { 
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1080", required = true, value = "取引金額（税込で指定してください）<br> マイナスの値を指定した場合、控除・マイナス行として登録されます。<br> 上記以外の値を指定した場合、通常行として登録されます。 ")
  ...
  public RenewUpdateParamsDetails description(String description) {
  ...
  **/
  ...
  public RenewUpdateParamsDetails itemId(Integer itemId) {
  ...
  **/
  ...
  public RenewUpdateParamsDetails sectionId(Integer sectionId) {
  ...
  **/
  ...
  public RenewUpdateParamsDetails tagIds(List<Integer> tagIds) {
    
    this.tagIds = tagIds;
    return this;
  }

  public RenewUpdateParamsDetails addTagIdsItem(Integer tagIdsItem) {
    if (this.tagIds == null) {
  ...
  **/
  ...
  public RenewUpdateParamsDetails taxCode(Integer taxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RenewUpdateParamsDetails renewUpdateParamsDetails = (RenewUpdateParamsDetails) o;
    return Objects.equals(this.accountItemId, renewUpdateParamsDetails.accountItemId) &&
        Objects.equals(this.amount, renewUpdateParamsDetails.amount) &&
        Objects.equals(this.description, renewUpdateParamsDetails.description) &&
        Objects.equals(this.itemId, renewUpdateParamsDetails.itemId) &&
        Objects.equals(this.sectionId, renewUpdateParamsDetails.sectionId) &&
        Objects.equals(this.segment1TagId, renewUpdateParamsDetails.segment1TagId) &&
        Objects.equals(this.segment2TagId, renewUpdateParamsDetails.segment2TagId) &&
        Objects.equals(this.segment3TagId, renewUpdateParamsDetails.segment3TagId) &&
        Objects.equals(this.tagIds, renewUpdateParamsDetails.tagIds) &&
        Objects.equals(this.taxCode, renewUpdateParamsDetails.taxCode) &&
        Objects.equals(this.vat, renewUpdateParamsDetails.vat);
  }
  ...
  public String toString() {
    ...
    sb.append("class RenewUpdateParamsDetails {\n");
