...
public class ItemResponseItem {
  ...
  public ItemResponseItem id(Integer id) {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "102", required = true, value = "品目ID")
  ...
  public ItemResponseItem companyId(Integer companyId) {
  ...
  **/
  ...
  public ItemResponseItem name(String name) {
  ...
  **/
  ...
  public ItemResponseItem shortcut1(String shortcut1) {
  ...
  **/
  ...
  public ItemResponseItem shortcut2(String shortcut2) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ItemResponseItem itemResponseItem = (ItemResponseItem) o;
    return Objects.equals(this.id, itemResponseItem.id) &&
        Objects.equals(this.companyId, itemResponseItem.companyId) &&
        Objects.equals(this.name, itemResponseItem.name) &&
        Objects.equals(this.shortcut1, itemResponseItem.shortcut1) &&
        Objects.equals(this.shortcut2, itemResponseItem.shortcut2);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemResponseItem {\n");
