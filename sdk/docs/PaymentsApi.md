...
public class Example {
    public static void main(String[] args) {
        ...
        DealPaymentParams parameters = new DealPaymentParams(); // DealPaymentParams | 取引（収入／支出）の支払行作成
        try {
            DealsResponse result = apiInstance.createDealPayment(id, parameters);
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | 取引ID
        Integer paymentId = 56; // Integer | 決済ID
        DealPaymentParams parameters = new DealPaymentParams(); // DealPaymentParams | 取引（収入／支出）の支払行更新
        try {
            DealsResponse result = apiInstance.updateDealPayment(id, paymentId, parameters);
            System.out.println(result);
        } catch (ApiException e) {
