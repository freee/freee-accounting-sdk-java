...
public class Example {
    public static void main(String[] args) {
        ...
        Integer startMonth = 56; // Integer | 発生月で絞込：開始会計月(mm)
        Integer endMonth = 56; // Integer | 発生月で絞込：終了会計月(mm)
 ...
 **startMonth** | **Integer**| 発生月で絞込：開始会計月(mm) | [optional]
 **endMonth** | **Integer**| 発生月で絞込：終了会計月(mm) | [optional]
 ...
 **adjustment** | **String**| 決算整理仕訳で絞込（決算整理仕訳のみ: only, 決算整理仕訳以外: without） | [optional] [enum: only, without]
 **costAllocation** | **String**| 配賦仕訳で絞込（配賦仕訳のみ：only,配賦仕訳以外：without） | [optional] [enum: only, not_include]
