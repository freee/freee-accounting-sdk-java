...
/**
 * The TrialBsTwoYearsResponseTrialBsTwoYears model.
 */
public class TrialBsTwoYearsResponseTrialBsTwoYears {
    ...
    private List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem> balances;
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withCompanyId(int companyId) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withFiscalYear(Integer fiscalYear) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withStartMonth(Integer startMonth) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withEndMonth(Integer endMonth) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withStartDate(String startDate) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withEndDate(String endDate) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withAccountItemDisplayType(String accountItemDisplayType) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withBreakdownDisplayType(String breakdownDisplayType) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withPartnerId(Integer partnerId) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withPartnerCode(String partnerCode) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withAdjustment(String adjustment) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withCreatedAt(String createdAt) {
     ...
     */
    public List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem> balances() {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYears object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYears withBalances(List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem> balances) {
