...
/**
 * The ItemsCreateResponseItem model.
 */
public class ItemsCreateResponseItem {
    /**
     * 品目ID.
     */
     ...
     * @return the ItemsCreateResponseItem object itself.
     */
    public ItemsCreateResponseItem withId(int id) {
        this.id = id;
        return this;
    }
     ...
     * @return the ItemsCreateResponseItem object itself.
     */
    public ItemsCreateResponseItem withCompanyId(int companyId) {
     ...
     * @return the ItemsCreateResponseItem object itself.
     */
    public ItemsCreateResponseItem withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ItemsCreateResponseItem object itself.
     */
    public ItemsCreateResponseItem withShortcut1(String shortcut1) {
     ...
     * @return the ItemsCreateResponseItem object itself.
     */
    public ItemsCreateResponseItem withShortcut2(String shortcut2) {
