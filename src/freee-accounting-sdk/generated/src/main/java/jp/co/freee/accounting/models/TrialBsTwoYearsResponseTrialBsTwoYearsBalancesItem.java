...
/**
 * The TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem model.
 */
public class TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem {
    /**
     * 勘定科目ID(勘定科目の時のみ含まれる).
     */
    ...
    private List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem> partners;
    ...
    private List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemItemsItem> items;
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withAccountItemId(Integer accountItemId) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withAccountItemName(String accountItemName) {
     ...
     */
    public List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem> partners() {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withPartners(List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem> partners) {
     ...
     */
    public List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemItemsItem> items() {
        return this.items;
    }
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withItems(List<TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemItemsItem> items) {
        this.items = items;
        return this;
    }
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withAccountCategoryId(Integer accountCategoryId) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withAccountCategoryName(String accountCategoryName) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withTotalLine(Boolean totalLine) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withHierarchyLevel(Integer hierarchyLevel) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withParentAccountCategoryId(Integer parentAccountCategoryId) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withParentAccountCategoryName(String parentAccountCategoryName) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withLastYearClosingBalance(Integer lastYearClosingBalance) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withClosingBalance(Integer closingBalance) {
     ...
     * @return the TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem object itself.
     */
    public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItem withYearOnYear(Double yearOnYear) {
