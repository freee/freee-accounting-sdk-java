...
/**
 * The TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem model.
 */
public class TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem {
    /**
     * 勘定科目ID(勘定科目の時のみ含まれる).
     */
    ...
    private List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem> partners;
    ...
    private List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem> items;
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withAccountItemId(Integer accountItemId) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withAccountItemName(String accountItemName) {
     ...
     */
    public List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem> partners() {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withPartners(List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem> partners) {
     ...
     */
    public List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem> items() {
        return this.items;
    }
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withItems(List<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem> items) {
        this.items = items;
        return this;
    }
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withAccountCategoryId(Integer accountCategoryId) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withAccountCategoryName(String accountCategoryName) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withTotalLine(Boolean totalLine) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withHierarchyLevel(Integer hierarchyLevel) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withParentAccountCategoryId(Integer parentAccountCategoryId) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withParentAccountCategoryName(String parentAccountCategoryName) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withTwoYearsBeforeClosingBalance(Integer twoYearsBeforeClosingBalance) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withLastYearClosingBalance(Integer lastYearClosingBalance) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withClosingBalance(Integer closingBalance) {
     ...
     * @return the TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem object itself.
     */
    public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem withYearOnYear(Double yearOnYear) {
