...
/**
 * The TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem model.
 */
public class TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem {
    /**
     * 勘定科目ID(勘定科目の時のみ含まれる).
     */
    ...
    private List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem> partners;
    ...
    private List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem> items;
    ...
    private List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem> sections;
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withAccountItemId(Integer accountItemId) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withAccountItemName(String accountItemName) {
     ...
     */
    public List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem> partners() {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withPartners(List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem> partners) {
     ...
     */
    public List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem> items() {
        return this.items;
    }
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withItems(List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem> items) {
        this.items = items;
        return this;
    }
     ...
     */
    public List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem> sections() {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withSections(List<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem> sections) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withAccountCategoryId(Integer accountCategoryId) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withAccountCategoryName(String accountCategoryName) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withTotalLine(Boolean totalLine) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withHierarchyLevel(Integer hierarchyLevel) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withParentAccountCategoryId(Integer parentAccountCategoryId) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withParentAccountCategoryName(String parentAccountCategoryName) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withLastYearClosingBalance(Integer lastYearClosingBalance) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withClosingBalance(Integer closingBalance) {
     ...
     * @return the TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem object itself.
     */
    public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem withYearOnYear(Double yearOnYear) {
