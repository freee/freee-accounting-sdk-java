...
/**
 * The TrialPlResponseTrialPl model.
 */
public class TrialPlResponseTrialPl {
    ...
    private List<TrialPlResponseTrialPlBalancesItem> balances;
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withCompanyId(int companyId) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withFiscalYear(Integer fiscalYear) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withStartMonth(Integer startMonth) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withEndMonth(Integer endMonth) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withStartDate(String startDate) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withEndDate(String endDate) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withAccountItemDisplayType(String accountItemDisplayType) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withBreakdownDisplayType(String breakdownDisplayType) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withPartnerId(Integer partnerId) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withPartnerCode(String partnerCode) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withSectionId(Integer sectionId) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withAdjustment(String adjustment) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withCostAllocation(String costAllocation) {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withCreatedAt(String createdAt) {
     ...
     */
    public List<TrialPlResponseTrialPlBalancesItem> balances() {
     ...
     * @return the TrialPlResponseTrialPl object itself.
     */
    public TrialPlResponseTrialPl withBalances(List<TrialPlResponseTrialPlBalancesItem> balances) {
