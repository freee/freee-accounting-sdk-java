...
/**
 * The RenewsUpdateDetailParams model.
 */
public class RenewsUpdateDetailParams {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withAccountItemId(int accountItemId) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withTaxCode(int taxCode) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withAmount(int amount) {
        this.amount = amount;
        return this;
    }
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withVat(Integer vat) {
        this.vat = vat;
        return this;
    }
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withSectionId(Integer sectionId) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withTagIds(List<Integer> tagIds) {
        this.tagIds = tagIds;
        return this;
    }
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withSegment1TagId(Integer segment1TagId) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withSegment2TagId(Integer segment2TagId) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withSegment3TagId(Integer segment3TagId) {
     ...
     * @return the RenewsUpdateDetailParams object itself.
     */
    public RenewsUpdateDetailParams withDescription(String description) {
