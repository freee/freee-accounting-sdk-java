...
public class CreateItemParams {
     ...
     * @return the CreateItemParams object itself.
     */
    public CreateItemParams withCompanyId(int companyId) {
     ...
     * @return the CreateItemParams object itself.
     */
    public CreateItemParams withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the CreateItemParams object itself.
     */
    public CreateItemParams withShortcut1(String shortcut1) {
     ...
     * @return the CreateItemParams object itself.
     */
    public CreateItemParams withShortcut2(String shortcut2) {
