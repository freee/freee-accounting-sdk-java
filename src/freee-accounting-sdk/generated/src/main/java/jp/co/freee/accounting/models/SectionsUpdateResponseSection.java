...
/**
 * The SectionsUpdateResponseSection model.
 */
public class SectionsUpdateResponseSection {
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withId(int id) {
        this.id = id;
        return this;
    }
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withLongName(String longName) {
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withCompanyId(int companyId) {
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withShortcut1(String shortcut1) {
     ...
     * @return the SectionsUpdateResponseSection object itself.
     */
    public SectionsUpdateResponseSection withShortcut2(String shortcut2) {
