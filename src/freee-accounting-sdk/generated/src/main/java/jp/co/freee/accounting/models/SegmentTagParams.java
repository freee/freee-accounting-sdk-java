...
public class SegmentTagParams {
     ...
     * @return the SegmentTagParams object itself.
     */
    public SegmentTagParams withCompanyId(int companyId) {
     ...
     * @return the SegmentTagParams object itself.
     */
    public SegmentTagParams withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SegmentTagParams object itself.
     */
    public SegmentTagParams withDescription(String description) {
     ...
     * @return the SegmentTagParams object itself.
     */
    public SegmentTagParams withShortcut1(String shortcut1) {
     ...
     * @return the SegmentTagParams object itself.
     */
    public SegmentTagParams withShortcut2(String shortcut2) {
