...
/**
 * The CreateDealParamsDetailsItem model.
 */
public class CreateDealParamsDetailsItem {
    /**
     * 税区分コード.
     */
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withTaxCode(Integer taxCode) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withTaxId(Integer taxId) {
        this.taxId = taxId;
        return this;
    }
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withAccountItemId(int accountItemId) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withAmount(int amount) {
        this.amount = amount;
        return this;
    }
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withSectionId(Integer sectionId) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withTagIds(List<Integer> tagIds) {
        this.tagIds = tagIds;
        return this;
    }
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withSegment1TagId(Integer segment1TagId) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withSegment2TagId(Integer segment2TagId) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withSegment3TagId(Integer segment3TagId) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withDescription(String description) {
     ...
     * @return the CreateDealParamsDetailsItem object itself.
     */
    public CreateDealParamsDetailsItem withVat(Integer vat) {
        this.vat = vat;
        return this;
    }
