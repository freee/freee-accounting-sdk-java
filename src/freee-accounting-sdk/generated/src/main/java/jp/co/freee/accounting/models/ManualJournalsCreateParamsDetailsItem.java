 ...
 */
public class ManualJournalsCreateParamsDetailsItem {
    /**
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withEntrySide(String entrySide) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withTaxCode(int taxCode) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withAccountItemId(int accountItemId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withAmount(int amount) {
        this.amount = amount;
        return this;
    }
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withVat(Integer vat) {
        this.vat = vat;
        return this;
    }
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withPartnerId(Integer partnerId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withPartnerCode(String partnerCode) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withItemId(Integer itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withSectionId(Integer sectionId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withTagIds(List<Integer> tagIds) {
        this.tagIds = tagIds;
        return this;
    }
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withSegment1TagId(Integer segment1TagId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withSegment2TagId(Integer segment2TagId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withSegment3TagId(Integer segment3TagId) {
     ...
     * @return the ManualJournalsCreateParamsDetailsItem object itself.
     */
    public ManualJournalsCreateParamsDetailsItem withDescription(String description) {
