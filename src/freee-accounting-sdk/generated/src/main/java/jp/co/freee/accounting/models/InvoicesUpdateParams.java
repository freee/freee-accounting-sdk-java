...
/**
 * The InvoicesUpdateParams model.
 */
public class InvoicesUpdateParams {
    ...
    /**
     * 請求書ステータス  (draft: 下書き (デフォルト), issue:
    ...
    private List<InvoicesUpdateParamsInvoiceContentsItem> invoiceContents;
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyId(int companyId) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withIssueDate(String issueDate) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPartnerId(Integer partnerId) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPartnerCode(String partnerCode) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withInvoiceNumber(String invoiceNumber) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withDueDate(String dueDate) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withBookingDate(String bookingDate) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withDescription(String description) {
        this.description = description;
        return this;
    }

    /**
     * Get 請求書ステータス  (draft: 下書き (デフォルト), issue: 発行(請求先ワークフローを利用している場合は承認済の請求書にのみ指定できます)). Possible values include: 'draft', 'issue'.
     *
    ...
    /**
     * Set 請求書ステータス  (draft: 下書き (デフォルト), issue: 発行(請求先ワークフローを利用している場合は承認済の請求書にのみ指定できます)). Possible values include: 'draft', 'issue'.
     *
     * @param invoiceStatus the invoiceStatus value to set
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withInvoiceStatus(String invoiceStatus) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPartnerName(String partnerName) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPartnerTitle(String partnerTitle) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPartnerContactInfo(String partnerContactInfo) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyName(String companyName) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyZipcode(String companyZipcode) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyPrefectureCode(Integer companyPrefectureCode) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyAddress1(String companyAddress1) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyAddress2(String companyAddress2) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withCompanyContactInfo(String companyContactInfo) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPaymentType(String paymentType) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withPaymentBankInfo(String paymentBankInfo) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withUseVirtualTransferAccount(String useVirtualTransferAccount) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withMessage(String message) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withNotes(String notes) {
        this.notes = notes;
        return this;
    }
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withInvoiceLayout(String invoiceLayout) {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withTaxEntryMethod(String taxEntryMethod) {
     ...
     */
    public List<InvoicesUpdateParamsInvoiceContentsItem> invoiceContents() {
     ...
     * @return the InvoicesUpdateParams object itself.
     */
    public InvoicesUpdateParams withInvoiceContents(List<InvoicesUpdateParamsInvoiceContentsItem> invoiceContents) {
